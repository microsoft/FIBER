...
```
If needing to support different GPU architectures, specify `TORCH_CUDA_ARCH_LIST="*.* ..."` before `python setup.py ...` (e.g., `TORCH_CUDA_ARCH_LIST="8.0 8.6 8.7 7.0 7.2 6.0 6.1 6.2"` for Ampere, Volta, and Pascal).
